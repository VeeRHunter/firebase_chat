        ...
        groupIds.forEach((groupId) => {
          ...
          this.dataProvider.getGroup(groupId.key).snapshotChanges().subscribe((groupRes) => {
            ...
            if (group.key != null) {
              ...
              this.tempData1.unreadMessagesCount = this.tempData1.messages.length - groupId.messagesRead;
              // Get group's last active date
              this.tempData1.date = this.tempData1.messages[this.tempData1.messages.length - 1].date;
